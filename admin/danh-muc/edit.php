...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box row">
            <div class="col-md-6">
                <form action="<?= ADMIN_URL . 'danh-muc/save-edit.php'?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?= $cate['id']?>">
                    <div class="form-group">
                        <label for="">Tên danh mục</label>
                        <input type="text" name="name" value="<?= $cate['name']?>" placeholder="Nhập tên danh mục" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <img src="<?= ASSET_URL . $cate['image']?>" alt="" class="img-responsive">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="">Ảnh</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="short_desc" rows="10" class="form-control"><?= $cate['short_desc']?></textarea>
                    </div>
